= diakonos: |-
  Common commands for the Diakonos text editor. (http://purepistos.net/diakonos)
  
  This guide is available at http://wiki.purepistos.net/doku.php?id=Diakonos:Getting-Started

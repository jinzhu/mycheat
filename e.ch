= e: "Keyboard shortcuts for E Text Editor (http://www.e-texteditor.com/)
  ...
  Ctrl+Space     : Word completion (also works with esc). 
  ...
  Ctrl+F3            : Find next instance of current word
  ...
  Ctrl+B             : Move cursor to the matching bracket
  ...
  Bundles: http://code.google.com/p/ebundles/
         http://github.com/gtcaz/ebundles/tree/master
         
         http://code.google.com/p/tmbundles4win/
         http://github.com/gtcaz/tmbundles4win/tree/master
        "
